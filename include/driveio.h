...
// The Systembus has shown sub-millisecond transitions at an end position.
// Keep raw samples for diagnostics, but require a stable value for state logic.
#define DRIVE_INPUT_FILTER_DURATION_MS 20
